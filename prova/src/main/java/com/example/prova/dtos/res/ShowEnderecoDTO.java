...
// Classe que representa o Data Transfer Object (DTO) para mostrar informações de endereço
public class ShowEnderecoDTO {

    // Atributo que representa o ID do endereço
    private Long id;

    // Atributo que representa o nome (pode ser nome da rua ou cidade)
    private String name;
    ...
    // Método que retorna o nome associado ao endereço
    public String getName() {
        return name;
    }

    // Método que define o nome associado ao endereço
