...
public class FuncionarioService {
    ...
    public void createFuncionario(Funcionario funcionario) {
        ...
        departamentoEntity.setNome(funcionario.getDepartamento().getNome());
        departamentoEntity.setGerente(funcionario.getDepartamento().getGerente());
        ...
        for (Projeto projeto : funcionario.getProjetos()) {
            ...
            if (projeto instanceof Futebol) {
                projetoEntity.setTipo("FUTEBOL");
            }
            if (projeto instanceof Basquete) {
                projetoEntity.setTipo("BASQUETE");
            }
            if (projeto instanceof Volei) {
                projetoEntity.setTipo("VOLEI");
            }
